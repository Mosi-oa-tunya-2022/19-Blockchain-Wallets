...
# Creating three columns to control placement of objects

st.markdown("## Fintech Finder! | Hire A Fintech Professional!")
col1 = st.sidebar
...
col1.markdown("## Client Account Address and Ethernet Balance in Ether")
...
person = st.sidebar.selectbox('Select a Block Chain Professional', people)

with col1:
  if person == "Lane":
    image = Image.open('Images/lane.jpeg')
    st.image(image)
  elif person == "Ash":
    image = Image.open('Images/ash.jpeg')
    st.image(image)
  elif person == "Jo":
    image = Image.open('Images/jo.jpeg')
    st.image(image)
  elif person == "Kendall":
    image = Image.open('Images/Kendall.jpeg')
    st.image(image)
    

# Create a input field to record the number of hours the candidate worked
hours = col1.number_input("Number of Hours")

col1.markdown("## Candidate Name, Hourly Rate, and Ethereum Address")
...
col1.write(hourly_rate)

# Identify the FinTech Finder candidate's Ethereum Address
candidate_address = candidate_database[person][1]

# Write the inTech Finder candidate's Ethereum Address to the sidebar
col1.write(candidate_address)

# Write the Fintech Finder candidate's name to the sidebar

col1.markdown("## Total Wage in Ether")
...
with col3:
  ...
  if person == "Lane":
    ...
    st.success("### Lane - EXPERT LEVEL")
    st.write("\n")
    st.warning("### PREMIUM: .20 ETH/HR")
  elif person == "Ash":
    image = Image.open('Images/ash.jpeg')
    st.image(image, width=350)
    st.success("### ASH - EXPERT LEVEL")
    st.write("\n")
    st.warning("### PREMIUM:  .33 ETH/HR")
  elif person == "Jo":
    image = Image.open('Images/jo.jpeg')
    st.image(image, width=350)
    st.success("### Jo - SENIOR LEVEL")
    st.write("\n")
    st.warning("### PREMIUM:  .19 ETH/HR")
  elif person == "Kendall":
    image = Image.open('Images/Kendall.jpeg')
    st.image(image, width=350)
    st.success("### Kendall - JUNIOR LEVEL")
    st.write("\n")
    st.warning("### PREMIUM:  .16 ETH/HR")
...
if col1.button("Send Transaction"):
    ...
    col1.markdown("#### Validated Transaction Hash")

    # Write the returned transaction hash to the screen
    col1.write(transaction_hash)
